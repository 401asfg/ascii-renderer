...
class TestScreen(unittest.TestCase):
    ...
    def test_overlay_single_pixel_empty(self):
    ...
    def test_overlay_larger_not_empty(self):
        top = Screen(Sprite(self.EMPTY_SPACE_CHAR), int(self.WIDTH + 6), int(self.HEIGHT + 6))
        ...
        [set_sprite_grid('x', x, y)
         for x in range(len(self.sprite_grid[0]))
         for y in range(len(self.sprite_grid))
         if y % 2 == 0]
    ...
    def test_overlay_different_empty_spaces(self):
        top = Screen(Sprite('a'), int(self.WIDTH), int(self.HEIGHT))
        ...
        [set_sprite_grid(self.EMPTY_SPACE_CHAR, x, y)
         for x in range(int(top.width / 2), top.width)
         for y in range(int(top.height / 2), top.height)]
